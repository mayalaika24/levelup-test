...
import {
  contactSchoolSettingsSchema,
  type ContactSchoolSettingsInput,
...
type ContactTabProps = {
  ...
  isSaving: boolean;
  onSave: (payload: ContactSchoolSettingsInput) => Promise<void>;
};

export function SchoolSettingsContactTab({ data, isSaving, onSave }: ContactTabProps) {
  ...
  } = useForm<ContactSchoolSettingsInput>({
    defaultValues: {
  ...
  async function handleSave(values: ContactSchoolSettingsInput) {
    const parsed = contactSchoolSettingsSchema.safeParse(values);
